...
})({"3zTc4":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
  ...
  <div class="p-6 ${element.read ? 'bg-red-500' : 'bg-white'} mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100">
        <div class="flex">
          ...
          <div class="text-center text-sm">
            <div class="w-10 text-white bg-green-300 rounded-lg px-0 py-2">${element.comments_count}</div>
          </div>
        </div>
        <div class="flex mt-3">
          <div class="grid grid-cols-3 text-sm text-gray-500">
            <div><i class="fas fa-user mr-1"></i>${element.user}</div>
            <div><i class="fas fa-heart mr-1"></i>${element.points}</div>
            <div><i class="far fa-clock mr-1"></i>${element.time_ago}</div>
          </div>  
        </div>
      </div>    
  `;
...
},{}]},["3zTc4","igcvL"], "igcvL", "parcelRequire94c2")
